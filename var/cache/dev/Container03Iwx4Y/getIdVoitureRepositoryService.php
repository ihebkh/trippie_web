 ...
 */
class getIdVoitureRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\IdVoitureRepository' shared autowired service.
     *
     * @return \App\Repository\IdVoitureRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'IdVoitureRepository.php';

        return $container->privates['App\\Repository\\IdVoitureRepository'] = new \App\Repository\IdVoitureRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
