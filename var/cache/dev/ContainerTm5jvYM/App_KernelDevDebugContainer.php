...
class App_KernelDevDebugContainer extends Container
{
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('jcnf+PP3Mq', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'uploads_directory' => (\dirname(__DIR__, 4).'/C:'.\DIRECTORY_SEPARATOR.'xampp'.\DIRECTORY_SEPARATOR.'htdocs'.\DIRECTORY_SEPARATOR.'image_trippie_cov'),
