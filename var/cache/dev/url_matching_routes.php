...
return [
    ...
    [ // $staticRoutes
        ...
        '/dashboard/stat2' => [[['_route' => 'stat2', '_controller' => 'App\\Controller\\VoitureController::VoitureStatistics2'], null, ['POST' => 0, 'GET' => 1], null, false, false, null]],
        '/voiture/search' => [[['_route' => 'search2', '_controller' => 'App\\Controller\\VoitureController::search2'], null, ['GET' => 0, 'POST' => 1], null, false, false, null]],
        '/voiture/tricroi' => [[['_route' => 'tri', '_controller' => 'App\\Controller\\VoitureController::triCroissant'], null, ['GET' => 0, 'POST' => 1], null, false, false, null]],
        ...
        '/voituremobile/list' => [[['_route' => 'list', '_controller' => 'App\\Controller\\VoituremobileController::getVoiture'], null, null, null, false, false, null]],
